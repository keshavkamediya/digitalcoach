...
const PrivacyPolicy = () => {
  return (
    <div className="py-40 container mx-auto">
      <h1 className="text-3xl py-5 font-semibold">Privacy Policy</h1>

      <div className="p-2">
        <h2 className="font-semibold text-lg">
          DigitalCoach4u operates the DigitalCoach4u.com website, which provides
          the SERVICE.
        </h2>
        ...
        <p className="p-2">
          ...
          anyone decided to use our Service, the DigitalCoach4u website.
        </p>
        ...
        <p className="p-2">
          ...
          Terms and Conditions, which is accessible at DigitalCoach4u.com,
        ...
        <h2 className="font-semibold text-lg">Log Data</h2>
        ...
        <p className="p-2">Children&apos;s Privacy</p>
